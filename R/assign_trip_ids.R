#' assign_trip_ids
#'
#' @param ais_data AIS data with a GRID_ID column
#' @param grid grid sf object with GRID_ID column
#' @param ports ports sf object with id column
#' @param min_gap_records number of consecutive non-port records required to consider a vessel as having departed a port (to smooth out yo-yoing at the port boundary)
#'
#' @returns ais_data with additional trip_id column (unique identifier for each vessel and trip)
#'
#' @export
#' @examples
